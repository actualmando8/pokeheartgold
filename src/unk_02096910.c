...
u32 sub_02096A34(void) {
    ...
    *((u16*)(r0 + 8)) = r0;
    ...
    // ldrb r0, [r0]
    ov80_022385D8(r0);
    Save_Frontier_GetStatic(*((u32*)r5));
    sub_0205C268(r4);
    FrontierSave_GetStat(r6, r4, r0);
    *((u16*)(r5 + 0xa)) = r0;
    // add r5, #8
    sub_02037030(0x39, r5, 0x28);
}
