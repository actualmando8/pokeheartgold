...
void ov90_0225C158(void) {
    /* Original at 0x0225C158 */
    /* Requires manual decompilation - 2 instructions */
    #ifdef MWERKS
    asm(
        "mov r0, #5\n    bx lr"
...
void ov90_0225C194(void) {
    /* Original at 0x0225C194 */
    /* Requires manual decompilation - 2 instructions */
    #ifdef MWERKS
    asm(
        "mov r0, #0\n    bx lr"
...
void ov90_0225C198(void) {
    /* Original at 0x0225C198 */
    /* Requires manual decompilation - 2 instructions */
    #ifdef MWERKS
    asm(
        "mov r0, #4\n    bx lr"
