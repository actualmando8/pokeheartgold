...
void ov01_021FF6DC(void) {
    ov01_021F18D4(*((u32*)r0), 6, 0x79);
    ov01_021F1908(*((u32*)r4), 6, 0x91);
    ov01_021F1930(*((u32*)r4), 7, 0x14, 1);
    // str r0, [sp]
    // str r0, [sp, #4]
    // str r0, [sp, #8]
    ov01_021F1758(*((u32*)r4), 8, 6, 6);
}
...
void ov01_021FF74C(void) {
    ...
    // str r0, [sp, #4]
    // add r2, sp, #8
    ov01_021F1620(r4, ov01_022091EC, 0);
}
