...
void FrtCmd_093(void) {
    /* Original at 0x0222F648 */
...
void FrtCmd_094(void) {
    /* Original at 0x0222F664 */
...
void FrtCmd_099(void) {
    /* Original at 0x0222F7E0 */
    /* Requires manual decompilation - 7 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, lr}
...
void FrtCmd_100(void) {
    /* Original at 0x0222F7F4 */
    /* Requires manual decompilation - 7 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, lr}
...
void FrtCmd_101(void) {
    /* Original at 0x0222F808 */
    /* Requires manual decompilation - 7 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, lr}
...
void FrtCmd_102(void) {
    /* Original at 0x0222F81C */
    /* Requires manual decompilation - 7 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, lr}
...
void FrtCmd_104(void) {
    /* Original at 0x0222FC34 */
    /* Requires manual decompilation - 11 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, r4, r5, lr}
