...
void sub_02085974(void) {
    /* Original at 0x02085974 */
    /* Requires manual decompilation - 292 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, r4, r5, r6, r7, lr}
    mov r1, #0xb2
...
void sub_02085C20(void) {
    /* Original at 0x02085C20 */
    /* Requires manual decompilation - 405 instructions */
    #ifdef MWERKS
    asm(
        "push {r3, r4, r5, r6, r7, lr}
    sub sp, #0x40
