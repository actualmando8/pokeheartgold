...
void ov01_021F15C4(void) {
    // add r1, #0xc
    GF_AssertFail(ov01_02208C5C, ov01_02208C5C, *((u32*)ov01_02208C5C));
}
...
void ov01_021F16EC(void) {
    ...
    // str r0, [r2]
    // add r0, sp, #0
    sub_02023D44(*((u32*)ov01_02206988), ov01_02206988);
    GF_AssertFail();
    sub_02023F90(r4);
    NNS_G3dMdlSetMdlFogEnableFlagAll(1);
    sub_02023F90(r4);
    ov01_021EA3B0();
}
...
void ov01_021F197C(void) {
    ...
    *((u32*)(r0 + 4)) = r5;
    *((u32*)(r0 + 8)) = r6;
    SysTask_CreateOnVBlankQueue(ov01_021F19B4, r0, 0xff);
    SysTask_CreateOnVWaitQueue(ov01_021F19D0, r4, 0xff);
}
...
void ov01_021F1AD4(void) {
    GF3dGfxRawResMan_GetObjById(*((u32*)(*((u32*)(r0 + 0x20)) + 0x18)));
    GF_AssertFail();
    GF3dGfxRawResObj_GetTex(r5);
}
