/*---------------------------------------------------------------------------*
  ...
  $Log: wm.h,v $
  Revision 1.169  07/06/2006 12:53:18  seiki_masashi
  Added platform to the WMGameInfo structure, and changed the version to 2

  Revision 1.168  07/06/2006 11:46:30  okubata_ryoma
  undo

  Revision 1.166  02/20/2006 06:47:38  seiki_masashi
  Added WM_GAMEINFO_LENGTH_MIN

  Revision 1.165  02/20/2006 02:24:45  seiki_masashi
  ...
  Revision 1.164  01/18/2006 02:12:39  kitase_hirotake
  do-indent

  Revision 1.163  12/01/2005 15:06:09  seiki_masashi
  ...
  Revision 1.135  03/08/2005 06:44:18  terui
  Added pwrMgtMode member to WMStatus structure.

  Revision 1.134  03/04/2005 08:51:19  seiki_masashi
  Changed so can also reference WMPortSendCallback size field by length.

  Revision 1.133  03/03/2005 14:44:37  seiki_masashi
  ...
  Revision 1.132  02/28/2005 05:26:35  yosizaki
  do-indent.

  Revision 1.131  02/24/2005 14:25:29  seiki_masashi
  Added constant WMi_DISCONNECT_REASON_*

  Revision 1.130  02/14/2005 13:39:42  seiki_masashi
  Added WM_STATECODE_UNKNOWN

  Revision 1.129  02/08/2005 06:45:05  ooe
  Revisions due to WM_StartScanEx specification change

  Revision 1.128  02/07/2005 06:52:57  terui
  ...
  Revision 1.127  02/03/2005 11:41:25  ooe
  Revisions due to addition of WM_SetWEPKeyEx

  Revision 1.126  01/26/2005 05:31:58  takano_makoto
  WMArm9Buf contained 32 bytes of useless padding. Deleted.

  Revision 1.125  01/26/2005 01:36:15  seiki_masashi
  Established WMARM9Buf.scanOnlyFlag

  Revision 1.124  01/18/2005 13:00:26  seiki_masashi
  Added WM_PACKED_PACKET_MAX

  Revision 1.123  01/17/2005 01:07:32  ooe
  ...
  Revision 1.122  01/11/2005 07:54:58  takano_makoto
  fix copyright header.

  Revision 1.121  01/07/2005 11:04:47  terui
  Expanded the buffer size for ARM7 and internally secured buffer for issuing requests asynchronously.

  Revision 1.120  12/27/2004 09:06:21  ooe
  Deleted WM_WEPMODE_232BIT that did not actually exist.

  Revision 1.119  12/27/2004 05:30:41  terui
  Added WM_API_REQUEST_ACCEPTED definition.

  Revision 1.118  11/10/2004 13:02:51  takano_makoto
  Revised the include file

  Revision 1.117  11/09/2004 02:45:23  seiki_masashi
  ...
  Revision 1.12  07/27/2004 07:32:24  yasu
  Add #pragma  warn_padding off

  Revision 1.11  07/27/2004 07:17:41  yasu
  Fix alignment 32 on WMpparam

  Revision 1.10  07/20/2004 01:24:34  terui
  ...
  Revision 1.9  07/14/2004 09:42:50  ooe
  Revisions due to StartScan argument changes

  Revision 1.8  2004/07/11 02:59:30  ooe
  Added WM_SetBeaconIndication()

  Revision 1.7  07/10/2004 12:52:39  miya
  Added beacon system

  Revision 1.6  07/10/2004 12:45:08  terui
  Modify comments.

  Revision 1.5  07/10/2004 09:30:30  ooe
  Added #define WM_APIID_VALARM_MP 23

  Revision 1.4  07/08/2004 09:50:35  terui
  Changes due to beginning of WM7 revision

  Revision 1.17  07/06/2004 08:04:27  Ooe
  Support for WL-1.56.00

  Revision 1.16  07/06/2004 05:49:05  Ooe
  Returned FIFO buffer size to 256 Bytes

  Revision 1.15  07/06/2004 02:08:24  Ooe
  Added WM_ATTR_FLAG_CS definition

  Revision 1.14  07/06/2004 01:51:28  Ooe
  Changed FIFO buffer size

  Revision 1.13  07/05/2004 13:01:47  Ooe
  Added ( ) to SYSTEM_BUF_SIZE

  Revision 1.12  07/03/2004 07:28:43  Ooe
  Changed definitions of size, etc

  Revision 1.11  07/02/2004 04:51:46  Miya
  Revised cache control size

  Revision 1.10  06/29/2004 06:50:27  Ooe
  ...
  Revision 1.8  06/25/2004 06:18:27  Ooe
  Added argument (pollbmp) to WM_SetMPData()

  Revision 1.7  06/25/2004 02:15:27  Ooe
  Fixed the DMA-related bug that was exposed by implementation of WM_SetGameInfo()

  Revision 1.6  06/24/2004 10:02:44  Ooe
  Added WM_SetGameInfo()

  Revision 1.5  2004/06/21 06:39:42  Ooe
  (none)

  Revision 1.4  06/19/2004 05:56:58  Miya
  modified header file reference

  Revision 1.3  06/19/2004 04:03:08  miya
  ver. up Marionea-1.48.00

  Revision 1.2  06/02/2004 04:18:40  miya
  (none)

  Revision 1.1  05/26/2004 08:47:17  terui
...
typedef struct WMDataSharingInfo
{
    ...
    u16     dataLength;                // Amount of shared data around 1 device
...
typedef struct WMStatus
{
    ...
    // Flag (32Byte) 36
    BOOL    apiBusy;                   // API executing flag (API issue prohibition flag depending on FIFO)
...
typedef struct WMGetWirelessCounterCallback
{
    ...
    u32     RX_RTS;                    // NOTE: Number of receiving RTS and then performing CTS response
