...
/*---------------------------------------------------------------------------*
  ...
  $Log: tlcf.y,v $
  Revision 1.19  05/11/2006 12:55:30  yasu
  Halted warning

  Revision 1.18  05/10/2006 03:14:01  yasu
  Corrected an error in the IF-ELSE-ENDIF conditional determination

  Revision 1.17  05/10/2006 02:06:00  yasu
  Added support for CodeWarrior 2.x

  Revision 1.16  03/30/2006 23:59:45  yasu
  changed creation year

  Revision 1.15  03/29/2006 13:13:22  yasu
  IF-ELSE-ENDIF support

  Revision 1.14  09/01/2005 04:30:58  yasu
  Support for Overlay Group

  Revision 1.13  08/26/2005 11:23:11  yasu
  overlay support for ITCM/DTCM

  Revision 1.12  06/22/2005 00:50:06  yasu
  Updated copyright year

  Revision 1.11  06/20/2005 12:21:48  yasu
  Changed Surffix to Suffix

  Revision 1.10  07/10/2004 04:06:17  yasu
  Support command 'Library'
  Support modifier ':x' on template
  Fix up line continue '\'

  Revision 1.9  07/02/2004 07:34:53  yasu
  Support OBJECT( )

  Revision 1.8  06/24/2004 07:18:54  yasu
  Support keyword "Autoload"

  Revision 1.7  06/14/2004 11:28:45  yasu
  support section filter "FOREACH.STATIC.OBJECTS=.sectionName"

  Revision 1.6  02/13/2004 07:13:03  yasu
  support SDK_IRQ_STACKSIZE

  Revision 1.5  02/05/2004 07:09:03  yasu
  change SDK prefix iris -> nitro

  Revision 1.4  01/15/2004 10:47:56  yasu
