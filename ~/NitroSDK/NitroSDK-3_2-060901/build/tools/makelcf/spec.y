...
/*---------------------------------------------------------------------------*
  ...
  $Log: spec.y,v $
  Revision 1.15  05/10/2006 02:06:00  yasu
  Added support for CodeWarrior 2.x

  Revision 1.14  09/01/2005 04:30:52  yasu
  Support for Overlay Group

  Revision 1.13  06/22/2005 00:50:06  yasu
  Updated copyright year

  Revision 1.12  06/20/2005 12:21:48  yasu
  Changed Surffix to Suffix

  Revision 1.11  07/10/2004 04:06:17  yasu
  Support command 'Library'
  Support modifier ':x' on template
  Fix up line continue '\'

  Revision 1.10  07/08/2004 02:58:53  yasu
