/*---------------------------------------------------------------------------*
  ...
  $Log: main.c,v $
  Revision 1.35  01/18/2006 02:11:23  kitase_hirotake
  do-indent

  Revision 1.34  11/21/2005 10:37:14  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.33  02/28/2005 05:26:15  yosizaki
  do-indent.

  Revision 1.32  11/02/2004 09:38:12  takano_makoto
  fix typo.

  Revision 1.31  05/24/2004 10:34:24  takano_makoto
  Fixed autotest code
...
//---------------------------------------------------------------------------
// A sample that uses a texture with a 256-color texture palette:
//
// HOWTO:
...
// Specify the texture to use and etc. by G3_TexImageParam(GX_TEXFMT_PLTT256, ...).
// Specify the palette to use by G3_TexPlttBase(..., GX_TEXFMT_PLTT256).
