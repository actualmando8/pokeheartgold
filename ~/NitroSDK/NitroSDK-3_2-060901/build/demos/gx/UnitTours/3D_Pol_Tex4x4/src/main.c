/*---------------------------------------------------------------------------*
  ...
  $Log: main.c,v $
  Revision 1.36  01/18/2006 02:11:23  kitase_hirotake
  do-indent

  Revision 1.35  11/21/2005 10:37:38  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.34  02/28/2005 05:26:15  yosizaki
  do-indent.

  Revision 1.33  11/02/2004 09:38:30  takano_makoto
  fix typo.

  Revision 1.32  05/24/2004 10:34:55  takano_makoto
  Fixed autotest code
...
//
// HOWTO:
// Load texture images and texture indices to the texture image slots by
...
// Specify the texture to use and etc. by G3_TexImageParam(GX_TEXFMT_COMP4x4, ...).
// Specify the palette to use by G3_TexPlttBase(..., GX_TEXFMT_COMP4x4).
