 ...
 *  Title      :
 *             Data for the display of affine extended, direct color bit map BG  
 *  Explanation:
 *                Performs rotation and scaling on the 256-color direct color bitmap of the
 *             affine expanded BG, and displays it.
 *
 ******************************************************************************
 */
// texture information
