/*---------------------------------------------------------------------------*
  ...
  Revision 1.7  11/21/2005 10:31:18  kitase_hirotake
  ...
  Revision 1.4  05/27/2004 09:23:04  takano_makoto
  Added Autotest code
  ...
  Revision 1.1  03/01/2004 09:01:11  takano_makoto
  Initial check in.
...
//  Description:
//        Affine converts (rotate / scale) the OBJ that holds the 1-dimensional mapping bitmap data
//      and displays it
//  Operation:
...
void NitroMain()
{
    ...
    while (1)
    {
        ...
        /* OAM configuration*/
        G2_SetOBJAttr(&s_OAMBuffer[0], // Specify the location of OAM
                      pos_x,           // X position
                      pos_y,           // Y position
                      0,               // Priority level
