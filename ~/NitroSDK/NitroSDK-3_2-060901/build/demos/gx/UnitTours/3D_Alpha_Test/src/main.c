/*---------------------------------------------------------------------------*
  ...
  Revision 1.30  11/21/2005 10:32:35  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.29  02/28/2005 05:26:14  yosizaki
  do-indent.

  Revision 1.28  11/02/2004 09:36:02  takano_makoto
  fix typo.

  Revision 1.27  05/24/2004 10:31:20  takano_makoto
  Fixed autotest code

  Revision 1.26  04/07/2004 01:23:27  yada
  fix header comment

  Revision 1.25  04/06/2004 12:48:07  yada
  fix header comment

  Revision 1.24  2004/02/24 05:25:21  yasu
  used OS_EnableIrqMask instead of OS_SetIrqMask

  Revision 1.23  02/09/2004 01:44:47  kitani_toshikazu
  Add default setting codes for auto testing.

  Revision 1.22  2004/02/05 07:09:02  yasu
  change SDK prefix iris -> nitro

  Revision 1.21  02/05/2004 01:15:24  kitani_toshikazu
...
//
// HOWTO:
// Call G3X_AlphaTest(TRUE, alpha), which enables alpha tests and specifies
//    the threshold.
//---------------------------------------------------------------------------
