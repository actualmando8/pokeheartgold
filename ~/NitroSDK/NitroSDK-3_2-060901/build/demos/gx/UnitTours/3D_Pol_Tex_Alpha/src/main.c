/*---------------------------------------------------------------------------*
  ...
  $Log: main.c,v $
  Revision 1.34  01/18/2006 02:11:24  kitase_hirotake
  do-indent

  Revision 1.33  11/21/2005 10:38:19  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.32  02/28/2005 05:26:16  yosizaki
  do-indent.

  Revision 1.31  11/02/2004 09:37:48  takano_makoto
  fix typo.

  Revision 1.30  05/24/2004 10:33:49  takano_makoto
  Fixed autotest code
  ...
  Revision 1.14  01/06/2004 12:54:09  nishida_kenji
  revise comments
...
//---------------------------------------------------------------------------
// A sample that use an alpha texture with a texture palette:
//
// HOWTO:
...
// Specify the texture to use, etc., by G3_TexImageParam(GX_TEXFMT_ALPHA, ...).
// Specify the palette to use by G3_TexPlttBase(..., GX_TEXFMT_ALPHA).
