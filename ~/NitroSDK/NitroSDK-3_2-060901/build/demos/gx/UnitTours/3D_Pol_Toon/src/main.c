/*---------------------------------------------------------------------------*
  ...
  $Log: main.c,v $
  Revision 1.35  01/18/2006 02:11:25  kitase_hirotake
  do-indent

  Revision 1.34  11/21/2005 10:38:46  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.33  02/28/2005 05:26:18  yosizaki
  do-indent.

  Revision 1.32  11/02/2004 09:38:43  takano_makoto
  fix typo.

  Revision 1.31  05/24/2004 10:35:12  takano_makoto
  Fixed autotest code

  Revision 1.30  04/07/2004 01:23:27  yada
  fix header comment

  Revision 1.29  04/06/2004 12:48:06  yada
  fix header comment
  ...
  Revision 1.22  01/29/2004 07:46:50  kitani_toshikazu
  ...
  Revision 1.13  01/06/2004 12:54:09  nishida_kenji
  revise comments

  Revision 1.12  01/06/2004 00:50:37  nishida_kenji
...
//
// HOWTO:
// Switch to toon shading mode by G3X_SetShading(GX_SHADING_TOON).
// Set up the toon(high-light) table by G3X_SetToonTable.
...
void NitroMain(void)
{
    ...
    GX_EndLoadTexPltt();               // Waiting the end of V-Blank interrupt
    ...
    while (1)
    {
        ...
        G3_TexImageParam(GX_TEXFMT_PLTT16,      // use a 16-color palette textures
                         GX_TEXGEN_NONE,        // no texgen
