/*---------------------------------------------------------------------------*
  ...
  Revision 1.8  11/21/2005 10:31:32  kitase_hirotake
  ...
  Revision 1.5  06/02/2004 13:08:38  takano_makoto
  Change EXTPLTT enum name.

  Revision 1.4  05/27/2004 09:23:10  takano_makoto
  Added Autotest code
  ...
  Revision 1.1  03/01/2004 09:01:42  takano_makoto
  Initial check in.
...
//  Description:
//        Affine converts (rotate / scale) the OBJ that holds the 1-dimensional mapping character  data
//      then displays it.
//  Operation:
