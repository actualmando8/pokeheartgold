/*---------------------------------------------------------------------------*
  ...
  Revision 1.36  11/21/2005 10:28:33  kitase_hirotake
  Changed SVC_WaitVBlankIntr to OS_WaitVBlankIntr

  Revision 1.35  06/27/2005 11:10:12  yosizaki
  add comment about DC_WaitWriteBufferEmpty().

  Revision 1.34  02/28/2005 05:26:03  yosizaki
  do-indent.

  Revision 1.33  11/02/2004 09:35:04  takano_makoto
  fix typo.

  Revision 1.32  07/06/2004 04:51:05  yosizaki
  change DmaFill to CpuFill (fix cache bug)

  Revision 1.31  05/24/2004 10:29:58  takano_makoto
  Fixed autotest code
  ...
  Revision 1.22  01/18/2004 07:12:43  nishida_kenji
  change the place of SVC_WaitVBlankIntr

  Revision 1.21  01/09/2004 12:02:34  nishida_kenji
  use OS_SetIrqCheckFlag at VBlankIntr()

  Revision 1.20  01/07/2004 09:38:05  nishida_kenji
  revises comments

  Revision 1.19  12/25/2003 11:00:09  nishida_kenji
  converted by GX_APIChangeFrom031212-2.pl

  Revision 1.18  12/17/2003 11:35:17  nishida_kenji
  use DC_FlushRange

  Revision 1.17  12/17/2003 09:00:20  nishida_kenji
