/*---------------------------------------------------------------------------*
  ...
  Revision 1.12  11/21/2005 10:56:33  kitase_hirotake
  ...
  Revision 1.9  09/30/2004 05:08:02  yada
  add OS_InitAlarm().  to remove it was mistake

  Revision 1.8  09/28/2004 12:21:26  yada
  ...
  Revision 1.5  06/08/2004 00:21:15  yada
  add '#pragma unused()' for FINALROM

  Revision 1.4  04/15/2004 06:51:12  yada
  only arranged comment

  Revision 1.3  03/08/2004 08:31:58  yada
  fixed top comment

  Revision 1.2  03/08/2004 06:07:33  yada
  You can now specify the allowed range parameter for sync V-alarm.    
  These changes are in line with that.    

  Revision 1.1  02/23/2004 12:08:36  yada
  firstRelease
