/*---------------------------------------------------------------------------*
  ...
  $Log: os_thread.c,v $
  Revision 1.111  08/16/2006 03:03:12  yosizaki
  add OSi_RescheduleThread

  Revision 1.110  08/16/2006 01:44:56  yosizaki
  ...
  Revision 1.103  09/06/2005 10:17:40  yasu
  indent revisions
  ...
  Revision 1.93  07/07/2005 05:21:49  yasu
  ...
  Revision 1.90  07/06/2005 08:39:12  yasu
  Enabled OSi_ExitThread_Destroy() also in SDK2.x

  Revision 1.89  07/06/2005 08:19:08  yasu
  Corrected build failure with SDK_VERSION_MAJOR=2

  Revision 1.88  07/06/2005 06:32:23  yasu
  ...
  Revision 1.86  07/05/2005 10:56:51  yasu
  Added include statement with utest.h

  Revision 1.85  07/05/2005 09:46:19  yasu
  Added OS_KillThread
  ...
  Revision 1.75  02/18/2005 06:21:55  yasu
  ...
  Revision 1.70  10/04/2004 10:06:30  yasu
  ...
  Revision 1.65  07/01/2004 09:42:28  yasu
  support autoload
  ...
  Revision 1.58  06/08/2004 00:38:48  yasu
  ...
  Revision 1.51  05/18/2004 12:16:32  yasu
  small fix

  Revision 1.50  05/18/2004 11:59:44  yasu
  ...
  Revision 1.41  04/07/2004 03:08:56  yasu
  ...
  Revision 1.33  02/26/2004 10:52:11  yasu
  RollBack to 1.31

  Revision 1.32  02/26/2004 10:36:25  yasu
  Add idle thread
  ...
  Revision 1.28  02/20/2004 08:28:53  yasu
  ...
  Revision 1.22  02/09/2004 11:17:22  yasu
  include code32.h

  Revision 1.21  02/05/2004 07:09:02  yasu
  ...
  Revision 1.8  11/26/2003 10:51:42  yasu
  Opened OS_GetCurrentThread/OS_SetCurrentThread and made it 'inline'

  Revision 1.7  11/26/2003 09:31:15  yasu
  Separated OS_Reschedule and created OS_SelectThread

  Revision 1.6  11/26/2003 01:27:13  yasu
  Changed the OS_CreateThread interface
  Added OS_InitThread

  Revision 1.5  11/25/2003 13:31:56  yasu
  Added ThreadQueue

  Revision 1.4  11/25/2003 09:26:37  yasu
  IdleThread formatting

  Revision 1.3  11/25/2003 06:28:32  yasu
  Change the OS_CreateThread argument type

  Revision 1.2  11/25/2003 05:02:11  yasu
  bug fixes

  Revision 1.1  11/25/2003 04:31:57  yasu
