/*---------------------------------------------------------------------------*
  ...
  Revision 1.52  08/09/2006 06:53:13  takano_makoto
  ...
  Revision 1.43  07/10/2004 06:11:24  yasu
  ...
  Revision 1.36  05/18/2004 12:16:09  yasu
  re-support OSi_IrqThreadQueue in irqHandler

  Revision 1.35  05/18/2004 11:59:44  yasu
  ...
  Revision 1.26  04/14/2004 04:13:31  yasu
  ...
  Revision 1.14  12/22/2003 13:38:56  yasu
  Lifted the prohibition on ARCH5 code

  Revision 1.13  12/17/2003 08:20:20  yasu
  Made the code to be shared with ARM7

  Revision 1.12  12/17/2003 06:27:44  yasu
  Added code for ARCH4

  Revision 1.11  12/16/2003 06:42:30  yasu
  In order to support ISDebugger, prohibited FIQ at the time the thread switches

  Revision 1.10  12/16/2003 06:01:03  yasu
  ...
  Revision 1.6  12/08/2003 10:11:00  yasu
  Deleted the unnecessary define

  Revision 1.5  12/08/2003 01:25:05  yasu
  Added SP_svc to 'context'

  Revision 1.4  12/01/2003 09:51:04  yasu
  Value saved in context changed: PC->PC+4

  Revision 1.3  11/30/2003 05:10:42  yasu
  Made it possible to call thread-related functions from interrupt service

  Revision 1.2  11/29/2003 04:36:30  yasu
  Revised names

  Revision 1.1  11/29/2003 03:58:56  yasu
  Changed file name  osInterruptBase.c -> os_irqhandler.c

  Revision 1.7  11/28/2003 12:01:57  yasu
  Added OSi_IRQHandler_Begin_Label/End_Label

  Revision 1.6  11/27/2003 13:39:14  yasu
  Fixed a bug in the jump table

  Revision 1.5  11/27/2003 10:14:18  yasu
  Changed ICE-related measures SDK_BB -> SDK_BB_ICE

  Revision 1.4  11/27/2003 07:34:55  yasu
  ...
  Revision 1.2  11/10/2003 02:33:19  yasu
  Added  'interrupt table'

  Revision 1.1  11/06/2003 13:39:01  yasu
