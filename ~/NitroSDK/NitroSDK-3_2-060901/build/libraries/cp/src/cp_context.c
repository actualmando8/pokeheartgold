/*---------------------------------------------------------------------------*
  ...
  $Log: cp_context.c,v $
  Revision 1.7  08/10/2006 01:37:31  okubata_ryoma
  Copyright fix

  Revision 1.6  08/09/2006 06:38:50  takano_makoto
  Increase speed using stm, ldm

  Revision 1.5  02/28/2005 05:26:03  yosizaki
  do-indent.

  Revision 1.4  01/12/2005 11:08:24  takano_makoto
  fix copyright header.

  Revision 1.3  01/12/2005 00:28:41  yada
  consider SDK_TCM_APPLY

  Revision 1.2  05/06/2004 10:46:43  takano_makoto
  Modify include file.

  Revision 1.1  05/06/2004 02:52:40  takano_makoto
  Initial Update.
