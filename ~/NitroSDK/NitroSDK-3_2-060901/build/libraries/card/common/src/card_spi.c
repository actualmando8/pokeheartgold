/*---------------------------------------------------------------------------*
  ...
  $Log: card_spi.c,v $
  Revision 1.28  05/15/2006 08:51:00  yosizaki
  ...
  Revision 1.11  12/08/2004 12:41:58 PM  yosizaki
...
{
    /*
     * Will appropriately correct for devices which may have invalid initial values in their status registers at the point they are first used.
     */
