/*---------------------------------------------------------------------------*
  ...
  $Log: wm_system.c,v $
  Revision 1.40  06/28/2006 23:57:15  seiki_masashi
  Revised the PortCallback initialization process

  Revision 1.39  05/25/2006 00:31:08  terui
  Revised the WmInitCore function to run with no interrupt
  Revised the WM_Finish function to run with no interrupt
  ...
  Revision 1.17  01/25/2005 01:57:25  yasu
  ...
  Revision 1.3  09/11/2004 06:09:12  yasu
