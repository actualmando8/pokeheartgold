/*---------------------------------------------------------------------------*
  ...
  $Log: wm_standard.c,v $
  Revision 1.25  07/06/2006 11:20:52  okubata_ryoma
  undo
  ...
  Chnages size of cache in WM_StartConnectEx to proper value.
  ...
  Replaced the warning about MP send/receive size with the warning about the time required for sending/receiving MP packets.
